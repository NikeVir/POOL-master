...
function AddItem(props){
  ...
  const onAddItemClick = async(e) => {
    ...
    data.append("upload_preset","showoff_data");
    data.append("cloud_name","dzprprdyw");
    await fetch("https://api.cloudinary.com/v1_1/dzprprdyw/image/upload",{
        method:"post",
        body:data
        ...
        const response = axios.post("http://localhost:5000/api/items/postItem/"+eee.auth.user.id, formData);
